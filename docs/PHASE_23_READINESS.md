...
Required secrets: `BETTER_AUTH_SECRET`, `API_KEY_PEPPER`, `APP_DATABASE_URL`, `WORKER_DATABASE_URL`, `DATABASE_ADMIN_URL`, `APP_MIGRATE_PASSWORD`, `APP_USER_PASSWORD`, `APP_WORKER_PASSWORD`, `APP_ADMIN_PASSWORD`, `REDIS_URL`, `RESEND_API_KEY`, `RESEND_FROM_EMAIL`, Stripe test (or later live only after explicit authorization), provider tokens.
