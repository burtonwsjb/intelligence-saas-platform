...
Status: **implemented**. Phase 16 is complete; see [PHASE_16.md](PHASE_16.md). Phase 17 is complete; see [PHASE_17.md](PHASE_17.md). Phase 18 is complete; see [PHASE_18.md](PHASE_18.md). Phase 19 is complete; see [PHASE_19.md](PHASE_19.md). Phase 20 is complete; see [PHASE_20.md](PHASE_20.md).
...
Commercial API, webhooks, usage meters, and OpenAPI are implemented in [PHASE_16.md](PHASE_16.md). Customer prediction reads stay disabled while visibility is shadow.
